...
type CategoryServiceClient interface {
	...
	ListCategories(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListCategoriesResponse, error)
...
func (c *categoryServiceClient) ListCategories(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListCategoriesResponse, error) {
...
type CategoryServiceServer interface {
	...
	ListCategories(context.Context, *Blank) (*ListCategoriesResponse, error)
...
func (UnimplementedCategoryServiceServer) ListCategories(context.Context, *Blank) (*ListCategoriesResponse, error) {
